...
export default function FormularioPago({
  ...
  const msgBs = `Hola, necesito saber el precio en Bs de este producto: ${productoUrl}`;
  const msgDivisas = `Hola, quiero pagar en Divisas y coordinar la entrega de este producto: ${productoUrl}`;
